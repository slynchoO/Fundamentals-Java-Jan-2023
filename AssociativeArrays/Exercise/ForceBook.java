...
public class ForceBook {
    public static void main(String[] args) {
        ...
        String input = sc.nextLine(); // //валидна команда или Lumpawaroo
        ...
        map.entrySet() //всички записи
                .stream().filter(entry -> entry.getValue().size() > 0) //оставяме само записите, които отговарят
                // на условието да имат хора в групата
